...
document.addEventListener('DOMContentLoaded', function() {
    const animatedElements = document.querySelectorAll('.project-card, .publication, .education-item, .contact-item');
...
function copyEmail() {
    const email = 'your.email@university.edu'; // Update with actual email
